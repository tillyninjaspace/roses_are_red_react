...
const Footer = () => {
    ...
    return (
        <div style={{padding: "15px", marginTop: "50px", backgroundColor: "darkgray", borderRadius: "5px"}}>
            ...
            <p style={{ color: "white"}}>Tech Stack: React, Bootstrap, Multer, Cloudinary, Jsonwebtoken, Node, Express, PSQL, HTML, CSS, Photoshop</p>
        </div>
    )
};
